...
$envVars = @(
  ...
  @{ key = 'AGGREGATION_REFRESH_MS'; value = '120000' },
  @{ key = 'BINANCE_REST_FALLBACK_MS'; value = '180000' },
  @{ key = 'BINANCE_ENABLE_OI_BATCH'; value = 'false' },
  @{ key = 'PERSIST_MARKET_DATA'; value = 'false' },
  @{ key = 'REDIS_URL'; value = '' },
